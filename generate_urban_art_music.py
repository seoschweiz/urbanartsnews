...
<section class="grid" id="urban-art-music-videos" aria-label="Urban Art Music video collection">{video_cards(videos, start)}</section>
...
<main>
<section class="content-layout"><article class="video-panel"><div class="player"><iframe src="https://www.youtube-nocookie.com/embed/{video_id}" title="{esc(title)}" loading="lazy" referrerpolicy="strict-origin-when-cross-origin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="video-meta"><a href="https://www.youtube.com/watch?v={video_id}" rel="nofollow noopener" target="_blank">{esc(config['watch'])} →</a><a class="subscribe-button" href="/subscribe/">{esc(SUBSCRIBE_LABELS[language])} →</a></div></article><aside class="mini-links" aria-label="Urban art links"><h2>Urban Art Links</h2><a href="https://urbanartsnews.com/urban-art-music/">Urban Art Music</a><a href="https://urbanartsnews.com/artists/">Urban Art Artists</a><a href="https://urbanartsnews.com/urban-art-gallery-news/">Urban Art Galleries</a><a href="https://urbanartsnews.com/street-art-galleries-barcelona/">Urban Art Gallery Barcelona</a><a href="https://urbanartsnews.com/subscribe/">Urban Art News Subscription</a></aside></section>
